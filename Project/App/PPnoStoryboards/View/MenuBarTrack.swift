...
class MenuBarTrack: UIView, UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    
    var homeController: TrackController?
...
//        }, completion: nil)
    ...
    let menuBarTitles: [String] = ["Track", "MyPosture"]
    ...
    func setupHorizontalBar() {
        ...
        horizontalBarView.backgroundColor = UIColor(white: 0.92, alpha: 1)
        addSubview(horizontalBarView)
        horizontalBarView.translatesAutoresizingMaskIntoConstraints = false
        
        horizontalBarLeftConstraint = horizontalBarView.leftAnchor.constraint(equalTo: self.leftAnchor)
        
        horizontalBarLeftConstraint?.constant = (UIScreen.main.bounds.width / 2)
